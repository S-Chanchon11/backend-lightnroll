...
print("Type of SVM: Linear , number of errors: ", err_count_lin/rounds, "accuracy: ", Acc_lin_avg/rounds)
print("Type of SVM: radial basis function , number of errors: ", err_count_rbf /rounds, "accuracy: ", Acc_rbf_avg/rounds)
